...
import br.com.devmidia.service.MusicaService;
...
public class MusicaController {
	...
	private MusicaService musicaService;
	 ...
	 @GetMapping("/listar")
	   ...
	   @GetMapping("/{musicaId}/atualizar") public ModelAndView preAtualizar(@PathVariable("playlistId")long playlistId, @PathVariable("musicaId") long musicaId, ModelMap model) {
